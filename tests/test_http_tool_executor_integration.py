...
async def test_multiple_tools_interaction():
...
async def test_file_based_schemas():
...
async def test_mixed_schema_sources():
...
async def test_multiple_tools_performance():
...
async def test_custom_base_url_in_generated_code():
...
async def test_regeneration_consistency():
